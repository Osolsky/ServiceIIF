 ...
 * @author UDI64-08
 */
public class ServicioC extends javax.swing.JFrame {
 SR SR = new SR ();
  DefaultTableModel mdlTable;
    ...
    public ServicioC() {
        initComponents();
         ...
         jTable1.setModel(SR.listaCatalogo());
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServicioC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
